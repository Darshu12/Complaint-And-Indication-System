...
$query=mysqli_query($con,"update student set fullName='$fname',contactNo='$contactno',address='$address',State='$state',country='$country',pincode='$pincode' where email='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <?php }?>
 <?php $query=mysqli_query($con,"select * from student where email='".$_SESSION['login']."'");
...
if($userphoto==""):
?>
<img src="studentimages/noimage.png" width="256" height="256" >
<a href="update-image.php">Change Photo</a>
<?php else:?>
	<img src="studentimages/<?php echo htmlentities($userphoto);?>" width="256" height="256">
	<a href="update-image.php">Change Photo</a>
<?php endif;?>
</div>
