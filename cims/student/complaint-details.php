...
<?php include('includes/sidebar.php');?>
 ...
 <?php $query=mysqli_query($con,"select complaints.*,category.categoryName as catname from complaints join category on category.id=complaints.category where studentId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
...
<?php $ret1=mysqli_query($con,"select facultyremark.ComplainRemark,facultyremark.ComplainStatus,facultyremark.PostingDate,
  ...
  join omplaints on complaints.complaintNumber=facultyremark.ComplainNumber 
