...
$query=mysqli_query($con,"insert into complaints(studentId,category,subcategory,complaintType,state,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$compfile')");
...
<html lang="en">
  <head>
    ...
    <title>CIMS | Student Register Complaint</title>
