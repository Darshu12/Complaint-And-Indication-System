...
$fwdfrom=$_SESSION['id'];
$sql=mysqli_query($con,"insert into forwardhistoryi(IndicationNumber,ForwardFrom,ForwardTo) values('$cno','$fwdfrom','$fwdto')");
if($sql)
{
echo "<script>alert('Indication forwaded successfully.');</script>";
echo "<script type='text/javascript'> document.location = 'notprocess-indication.php'; </script>";
} else 
{
echo "<script>alert('Indication forwaded successfully.');</script>";
}
...
<head>
	...
	<title>Admin| Indication Details</title>
...
<td colspan="5" style="color:red"><?php if($row['status']=="0"){ echo "Not Process Yet";
} else {
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Complaint Number# <?php echo $_GET['id'];?></h4>
      </div>
