...
<?php 
$st='closed';
$query=mysqli_query($con,"select complaints.*,student.fullName as name from complaints join student on student.id=complaints.studentId where complaints.status='$st'");
