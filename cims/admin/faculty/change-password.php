...
{
$sql=mysqli_query($con,"SELECT Password FROM  faculty where Password='".md5($_POST['password'])."' && FacultyName='".$_SESSION['subalogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update subadmin set Password='".md5($_POST['newpassword'])."' where FacultyName='".$_SESSION['subalogin']."'");
