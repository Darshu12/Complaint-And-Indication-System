...
$subid=$_SESSION['suid'];
$query=mysqli_query($con,"update faculty set FacultyName='$fname',emailid='$emailid',ContactNumber='$contactno' where id='$subid'");
...
<form class="form-horizontal row-fluid" name="facultyprofile" method="post">

<?php
$subid=$_SESSION['suid'];
$query=mysqli_query($con,"select * from faculty where id='$subid'");
...
<div class="control-group">
<label class="control-label" for="basicinput"><strong>Faculty Name</strong></label>
<div class="controls">
    <input type="text" name="fname" value="<?php echo isset($row['FacultynName']) ? $row['FacultynName'] : ''; ?>" class="span8 tip" required>
</div>
</div>
