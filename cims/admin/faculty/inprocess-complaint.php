...
<head>
	...
	<title>Faculty| In Process Complaints</title>
...
$subid=$_SESSION['suid'];
$st='in process';
$query=mysqli_query($con,"select complaints.*,student.fullName as name 
	from complaints 
	...
	where complaints.status='$st' and forwardhistory.ForwardTo='$subid'");
