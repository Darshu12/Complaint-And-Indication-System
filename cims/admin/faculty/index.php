...
if (isset($_POST['submit'])) {
	...
	$ret = mysqli_query($con, "SELECT * FROM admin WHERE username='$username' and password='".md5($_POST['password'])."'");
	...
	if ($num > 0) {
		...
		$ret1 = mysqli_query($con, "SELECT * FROM faculty WHERE UserName='$username' and Password='".md5($_POST['password'])."'");
		$num1 = mysqli_fetch_array($ret1);
		if ($num1 > 0) {
			$acctstatus = $num1['IsActive'];
			if ($acctstatus == '1') {
				$extra = "faculty/dashboard.php";//
			...
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
				  ...
				  <a class="brand" href="../index.html">
					  Complaint Mnagaement And Indication System | Admin Faculty
				  </a>
